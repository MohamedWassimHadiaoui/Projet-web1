...
switch ($action) {
    ...
    case 'login':
        ...
        break;
    case 'register':
        include __DIR__ . '/template/register.html';
        break;
    case 'profile':
        include __DIR__ . '/template/profile.html';
        break;
    case 'forum':
        include __DIR__ . '/template/forum.html';
        break;
    case 'events':
        include __DIR__ . '/template/events.html';
        break;
    case 'reports-management':
        include __DIR__ . '/template/reports-management.html';
        break;
    case 'create-report':
        include __DIR__ . '/template/create-report.html';
        break;
