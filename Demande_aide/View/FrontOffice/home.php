...
<body>
    ...
    <section class="hero">
        <div class="container">
            ...
            <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap; margin-top: 2rem;">
                <a href="index.php?action=register" class="btn btn-secondary btn-lg">Commencer maintenant</a>
            ...
            <div class="grid grid-4">
                ...
                <div class="card fade-in">
                    ...
                    <div class="card-footer">
                        <a href="index.php?action=help-requests&method=create" class="btn btn-primary">Signaler</a>
                    </div>
                </div>
                ...
                <div class="card fade-in">
                    ...
                    <div class="card-footer">
                        <a href="index.php?action=help-requests&method=create" class="btn btn-primary">Demander</a>
                    </div>
                </div>
                ...
                <div class="card fade-in">
                    ...
                    <div class="card-footer">
                        <a href="index.php?action=forum" class="btn btn-primary">Voir le forum</a>
                    </div>
                </div>
                ...
                <div class="card fade-in">
                    ...
                    <div class="card-footer">
                        <a href="index.php?action=events" class="btn btn-primary">Voir les événements</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section">
        <div class="container">
            ...
            <!-- Stats Section (Integrated from PHP) -->
            <div class="grid grid-3" style="margin-top: 3rem;">
                ...
                <div class="card">
                    <div class="card-body" style="text-align: center;">
                        <h3 style="font-size: 2.5rem; color: var(--color-primary); margin-bottom: 0.5rem;"><?= count($helpRequests) ?></h3>
                        <p class="text-muted">Demandes d'aide</p>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body" style="text-align: center;">
                        <h3 style="font-size: 2.5rem; color: var(--color-primary); margin-bottom: 0.5rem;"><?= count($organisations) ?></h3>
                        <p class="text-muted">Organisations partenaires</p>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body" style="text-align: center;">
                        <h3 style="font-size: 2.5rem; color: var(--color-primary); margin-bottom: 0.5rem;">24/7</h3>
