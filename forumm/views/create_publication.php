    ...
    <div class="container" style="max-width: 800px; margin: 2rem auto;">
        ...
        <form method="POST" action="create_publication.php" onsubmit="return validatePublicationForm()">
            <div class="form-group">
                ...
                <input type="text" id="auteur" name="auteur" class="form-control" required onblur="validateField('auteur')" maxlength="100" value="<?php echo isset($_POST['auteur']) ? htmlspecialchars($_POST['auteur']) : ''; ?>">
                <span class="form-error" id="auteurError"></span>
            </div>
            
            <div class="form-group">
                <label for="titre" class="form-label">Titre *</label>
                <input type="text" id="titre" name="titre" class="form-control" required onblur="validateField('titre')" maxlength="255" value="<?php echo isset($_POST['titre']) ? htmlspecialchars($_POST['titre']) : ''; ?>">
            ...
            <div class="form-group">
                ...
                <textarea id="contenu" name="contenu" class="form-control" rows="10" required onblur="validateField('contenu')" maxlength="5000"><?php echo isset($_POST['contenu']) ? htmlspecialchars($_POST['contenu']) : ''; ?></textarea>
