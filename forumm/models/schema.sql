...
INSERT INTO publication (titre, contenu, categorie, tags, auteur, statut) VALUES
('Bienvenue sur le forum', 'Ceci est un message de bienvenue pour tester le forum. N''hésitez pas à créer vos propres publications !', 'discussion', 'bienvenue,forum', 'Administrateur', 'approved'),
('Besoin de conseils', 'Bonjour à tous, j''ai besoin de conseils pour signaler un incident. Merci pour votre aide.', 'support', 'conseils,soutien', 'Sophie Martin', 'approved'),
('Mon expérience positive', 'Je voulais partager mon expérience positive avec la médiation communautaire. C''était vraiment utile !', 'experience', 'médiation,expérience', 'Jean Dubois', 'pending');
